...
function ProductSample() {
  ...
  return (
    <Grid className={classes.root}>
      <Grid container>
        <Avatar className={classes.productAvatar} src={productImage} alt="" />
      </Grid>
      <Grid className={classes.productSamples} container justifyContent="flex-start" alignItems="center">
        {data.map((img, index) => {
          return (
            <Avatar
              style={{
